...
public class NavigationDrawerActivityMultipane extends MaterialNavigationDrawer implements MaterialAccountListener {
    ...
    public void init(Bundle savedInstanceState) {
        ...
        section2 = this.newSection("Section 2",new MaterialSectionListener() {
            ...
            public void onClick(MaterialSection section) {
                Toast.makeText(NavigationDrawerActivityMultipane.this, "Section 2 Clicked", Toast.LENGTH_SHORT).show();
