...
public class NavigationDrawerImageHeaderActivity extends MaterialNavigationDrawer {
    ...
    public void init(Bundle savedInstanceState) {
        ...
        this.setDrawerHeaderImage(this.getResources().getDrawable(R.drawable.mat2));
        ...
        section2 = this.newSection("Section 2",new MaterialSectionListener() {
            ...
            public void onClick(MaterialSection section) {
                Toast.makeText(NavigationDrawerImageHeaderActivity.this, "Section 2 Clicked", Toast.LENGTH_SHORT).show();
